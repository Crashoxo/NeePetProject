                        ...
                        <div class="card">
                            <div class="card-header" style="background-color:white;">
                                <div style="display: flex;">
                                    <h2> <i class="fas fa-sticky-note" style="display: block; justify-content: left;">訂單查詢-已出貨</i></h2>
                                    <a href="./noOrderV.php" class="btn btn-primary mx-3">未出貨</a>
                                </div>
                            </div>

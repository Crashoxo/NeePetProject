...
$sql_query = "SELECT * FROM booking  LEFT JOIN member ON booking.memberID = member.memberID WHERE bstatus='尚未服務'  ORDER BY bookingID ASC";
                        ...
                        <div class="card">
                            <div class="card-header" style="background-color:white;">
                                ...
                                <div style="display: flex;">
                                    <h2> <i class="fas fa-sticky-note" style="display: block; justify-content: left;">預約查詢</i></h2>
                                    <a href="./bookingV-ok.php" class="btn btn-info mx-3">歷史預約紀錄</a>
                                </div>
                            </div>
                            <div class="card-body">

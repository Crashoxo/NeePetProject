    ...
    <div class="footer-menus">
        <div class="footer-menu__item">
            ...
            <div>
                ...
                <h6 class="word"><i class="fas fa-phone mr-1"></i> 04-8888-8888
                </h6>
                <h6 class="word">
        ...
        <div class="footer-menu__item divNone">
            <div class="footer-menu__items">
                <div class="footer-new">
                    ...
                    <a href="../stores.php">銷售據點</a>
                    <a href="../contact_us.php">聯絡我們</a>
                </div>
                <div class="footer-new">
                    <a href="../benefits.php">會員權益</a>
                    <a href="../notes.php">購物須知</a>
                    <a href="../delivery.php">配送服務</a>
                    <a href="../Q&A.php">常見問題</a>
                </div>
                <div class="footer-new">
                    <a href="../users-html.php">會員專區</a>
                    <a href="../terms.php">購物條款</a>
                    <a href="../privacy.php">隱私權條款</a>

<header class="header-nav">
    ...
    </svg><a href="../index.php" class="logo">寵愛NEE</a>


    <?php
    echo "<div class='nav-bar'>";
    if (isset($_SESSION['name'])) {
        echo "<a href='./mall.php' class=''>購物商城</a>";
    ...
    <form id="keyWordForm" action="mall.php" method="get" class="search-form">
    ...
    <div class="shopping-cart">
        ...
        ?>
            <div class="box">
                <div>
                    <a href="action.php?remove=<?= $row['cartID'] ?>" class="text-danger lead" onclick="return confirm('確定清除該商品？');"><i class="fas fa-trash-alt" aria-hidden="true"></i></a>
                </div>
                <!-- hidden find才能抓到值 -->
        ...
        <a href="cart.php" class="user-btn">購物車</a>
    </div>
    ...
    <form action="" class="btn-login-form">
        ...
        <!-- <a href="" class="user-btn">會員中心</a>
            <a href="" class="user-btn">查詢訂單</a>
            <a href="" class="user-btn">查詢預約</a> -->
        <?php if (isset($_SESSION['name'])) {
            echo "<a href='../users-html.php' class='user-btn'>會員中心</a>";
            echo "<a href='../orders/OrderDetail.php' class='user-btn'>查詢訂單</a>";

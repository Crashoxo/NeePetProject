...
include("./control/dataProductOFFC.php");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
                        ...
                        <div class="card">
                            <div class="card-header" style="background-color:white;">
                                ...
                                <div style="display: flex;">
                                    <h2><i class="fas fa-shopping-bag" style="display: block; justify-content: left;">商城系統-下架中(<?php echo $total_records; ?>)</i></h2>
                                    <a href="./addProductV.php" class="btn btn-success mx-3">新增商品</a>
                                    <a href="./dataProductV.php" class="btn btn-danger mx-3">上架專區</a>
                                </div>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-success universal-online-btn" onclick='editOn(<?= $row_result["productsID"] ?>)'>上架</a>
                ...
                <div style="display: flex; ">
                    ...
                    <div style="display: inline-flex; flex-direction: column;">
                        <form id="formON">
                            ...
                            <input type="date" name="onDateProduct" id="onDateProduct">
                            <h6 class="mt-3" style="display: flex;">下架日期：</h6>
                            <input type="date" name="offDateProduct" id="offDateProduct">
                            <input type="hidden" name="getOnPID" id="getOnPID"><br>
    ...
    <div class="on-comfirm-box-sec">
        <div class="on-lightbox-sec active">
            <div class="on-lightbox__inner-sec">
                ...
                <div class="btns">
                    <a id="submitOnDate" href="#" class="btn btn-danger on-comfirm-btn1 m-3">確定</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        // 上架進資料庫撈日期
        function editOn(productID) {
            $.ajax({
                url: "./control/updateProductC.php?action=selectOn&productID=" + productID,
                type: "GET",
                success: function(res) {
                    console.log(res);
                    let getRes = res.split("&");
                    $('#onDateProduct').val(getRes[0]);
                    $('#offDateProduct').val(getRes[1]);
                    $('#getOnPID').val(productID);
                }
            })
        ...
        // 上架modal確認送出
		$('#submitOnDate').on('click', function() {
			let data = $('#formON').serialize();
			$.ajax({
				url: "./control/updateProductC.php",
				method: 'post',
				data: data + '&action=onProduct',
				success: function(res) {
					console.log(res);
                    setTimeout(() => {
                        location.reload();

...
if (isset($_POST["action"]) && ($_POST["action"] == "add")) {
  ...
  try {
    $sql_query = "INSERT INTO products (categoryid ,productname ,productprice ,productstock ,productdiscount ,productstatus,onlinedate,offlinedate,productvote,productnews,productshowimg,productsold) 
  VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
    $stmt = $db_link->prepare($sql_query);
    $stmt->bind_param("isiidssssssi", $categoryID, $productName, $productPrice, $productStock, $productDiscount, $productStatus, $onlineDate, $offlineDate, $productVote, $productNews, $filename, $productSold);
    $stmt->execute();

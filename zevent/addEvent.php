  ...
  <form action="addEventC.php" method="POST" name="eventFormAdd" id="eventFormAdd" enctype="multipart/form-data">
    <table border="1" align="center" cellpadding="4">
      ...
      <tr>
        ...
        <td>
          <input type="text" class="form-control" name="newscontent" id="newscontent" placeholder="請輸入公告內容">
      ...
      <tr>
        ...
        <td>
          <select class="form-control" name="newstatus" id="newstatus">
            <option value="1">狀態1</option>
            <option value="2">狀態2</option>
            <option value="3">狀態3</option>
            <option value="4">狀態4</option>
          </select>
        </td>
      </tr>

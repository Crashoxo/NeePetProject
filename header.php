...
<header class="header-nav">
    ...
    <div class="shopping-cart">
        ...
        ?>
            <div class="box">
                <div class="aaa">
                    <a href="./testShop/action.php?remove=<?= $row['cartID'] ?>" class="text-danger lead" onclick="return confirm('確定清除該商品？');"><i class="fas fa-trash-alt" aria-hidden="true"></i></a>
                </div>
                <!-- hidden find才能抓到值 -->
    ...
    <form action="" class="btn-login-form">
        ...
        <?php if (isset($_SESSION['name'])) {
            ...
            echo "<a href='./orders/OrderDetail.php' class='user-btn'>訂單查詢</a>";
            echo "<a href='./SearchBooking.php' class='user-btn'>預約查詢</a>";
            echo "<a href='./logoutC.php' class='user-btn'>登出</a>";
        } else {
            echo "<a href='./login.php' class='user-btn'>會員中心</a>";
            echo "<a href='./login.php' class='user-btn'>訂單查詢</a>";
            echo "<a href='./login.php' class='user-btn'>預約查詢</a>";
